...
export const DEFAULT_SETTINGS: FeatureSettings = {
  ...
  // Exercise features
  exercises: {
    basic: true,       // ✅ Basic Exercises (ENABLED for admin)
    advanced: true,    // ✅ Advanced Exercises (ENABLED for admin)
  },
  // Game features
  games: {
  ...
  try {
    ...
    if (success && data) {
      ...
      const mergedSettings: FeatureSettings = {
        ...
        exercises: {
          basic: data.exercises?.basic ?? DEFAULT_SETTINGS.exercises.basic,
          advanced: data.exercises?.advanced ?? DEFAULT_SETTINGS.exercises.advanced,
        },
        games: {
