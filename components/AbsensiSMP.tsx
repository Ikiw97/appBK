                    ...
                    <tr key={siswa.id} className="border-b border-gray-200 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-center">
                        <button
                          ...
                          className={`w-8 h-8 rounded font-bold transition-colors ${existingRecord?.status === 'Hadir'
                      ...
                      <td className="py-3 px-4 text-center">
                        <button
                          ...
                          className={`w-8 h-8 rounded font-bold transition-colors ${existingRecord?.status === 'Ijin'
                      ...
                      <td className="py-3 px-4 text-center">
                        <button
                          ...
                          className={`w-8 h-8 rounded font-bold transition-colors ${existingRecord?.status === 'Sakit'
                      ...
                      <td className="py-3 px-4 text-center">
                        <button
                          ...
                          className={`w-8 h-8 rounded font-bold transition-colors ${existingRecord?.status === 'Alfa'
                      ...
                      <td className="py-3 px-4 text-center">
                        <button
                          ...
                          className={`w-8 h-8 rounded font-bold text-xs transition-colors ${existingRecord?.status === 'Terlambat'
                      ...
                      <td className="py-3 px-4 text-center">
                        <button
                          ...
                          className={`w-8 h-8 rounded font-bold text-xs transition-colors ${existingRecord?.status === 'Izin Keluar'
        ...
        <div className="card p-6">
          ...
          <div className="mb-6 flex gap-4 flex-wrap">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-all ${(laporanViewType as string) === 'ringkas'
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-all ${(laporanViewType as string) === 'detail'
                ? 'bg-blue-600 text-white'
                : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                }`}
            >
    ...
    <div className="px-6 md:px-8 py-8">
      ...
      <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-all whitespace-nowrap ${activeTab === 'input'
            ? 'bg-blue-600 text-white'
            : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
            }`}
        >
        ...
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-all whitespace-nowrap ${activeTab === 'laporan'
            ? 'bg-blue-600 text-white'
            : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
            }`}
        >
        ...
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-all whitespace-nowrap ${activeTab === 'statistik'
            ? 'bg-blue-600 text-white'
            : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
            }`}
        >
