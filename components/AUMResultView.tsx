    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-8 print:py-0 print:bg-white px-4 md:px-8 print:px-0">
      <div className="max-w-4xl mx-auto print:max-w-full">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden print:shadow-none print:rounded-none">
          {/* Header Section */}
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 print:p-2 print:bg-white print:text-black print:border-b-2 print:border-gray-800">
            <h1 className="text-2xl md:text-3xl font-bold mb-4 print:mb-1 print:text-xl print:text-center uppercase text-center">Hasil Asesmen AUM Umum</h1>
            ...
            <div className="text-blue-100 text-sm mt-2 print:hidden">
              Tanggal Pengisian:{' '}
