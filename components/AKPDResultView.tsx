      ...
      <div className="max-w-4xl mx-auto print:max-w-full">
        ...
        <div className="card p-4 md:p-8 mb-8 print:p-0 print:shadow-none print:mb-0 print:border-none">
          ...
          {(() => {
            ...
            if (descriptionData) {
              return (
                <div className="bg-white border-l-4 border-purple-500 p-4 rounded-lg mt-6 print:border-l-2 print:text-sm shadow-sm md:shadow-none border border-gray-100 md:border-none">
