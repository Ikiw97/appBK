    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response: SociometryResponse = {
                ...
                student_gender: mySelf.jenis_kelamin || 'Unknown',
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
                    ...
                    <div className="text-left mb-6">
                        ...
                        <div className="mt-4 p-3 bg-yellow-50 text-xs text-yellow-800 rounded border border-yellow-200">
                            ...
                            Target Kelas Sosiometri: {session.class_id}<br />
                            Jumlah Siswa Ditemukan: {students.length}<br />
                            Kelas yang punya data di Memory: {Object.keys(getAllSiswaData()).filter(k => getAllSiswaData()[k].length > 0).join(', ') || 'Tidak ada data siswa'}
                        </div>
                    </div>
