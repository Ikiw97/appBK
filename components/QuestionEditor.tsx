...
export default function QuestionEditor({ onBack }: QuestionEditorProps) {
  ...
  // Removed authorization check - all authenticated users can edit questions
      ...
      <div className="card p-6 mb-6">
        ...
        <div className="flex gap-4">
          <button
            ...
            className={`flex-1 px-6 py-3 rounded-lg font-medium transition-all ${assessmentType === 'akpd'
          ...
          <button
            ...
            className={`flex-1 px-6 py-3 rounded-lg font-medium transition-all ${assessmentType === 'aum'
              ? 'bg-blue-600 text-white'
              : 'bg-gray-100 text-gray-800 hover:bg-gray-200'
              }`}
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          {getCategories().map((category) => (
            <button
              ...
              className={`p-3 rounded-lg font-medium transition-all text-sm ${selectedCategory === category.id
                ? 'bg-blue-600 text-white'
                : 'bg-gray-100 text-gray-800 hover:bg-gray-200'
                }`}
            >
      ...
      <div className="card">
        ...
        <div className="p-6 bg-gray-50 border-t border-gray-200">
          <button
            ...
            disabled={loading}
            className={`flex items-center gap-2 px-6 py-3 rounded-lg transition-colors font-medium w-full justify-center ${loading
