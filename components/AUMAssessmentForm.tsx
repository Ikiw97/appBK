...
export default function AUMAssessmentForm({ onBack, schoolMode }: AUMAssessmentFormProps) {
  ...
  // Initialize with fallback/empty to allow render if needed, but useEffect will overwrite
  // Use DB loader
  useEffect(() => {
          ...
          <div className="card p-4 md:p-8 shadow-sm">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <button
                ...
                className="btn-primary w-full text-base md:text-lg py-3 mt-4 active:scale-[0.98]"
              >
                Mulai Asesmen
              </button>
            </div>
