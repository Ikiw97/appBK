  ...
  if (isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm h-16 md:h-20">
        ...
        <main className={isAdminOrTeacher ? 'md:ml-64 transition-all duration-300 pt-4' : 'pt-4'}>
          <Component
            {...pageProps}
            currentPage={currentPage}
            setCurrentPage={setCurrentPage}
